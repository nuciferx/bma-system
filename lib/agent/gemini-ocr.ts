...
กฎเด็ดขาด: อ่านได้ชัดเจนเท่านั้นจึงใส่ข้อมูล ถ้าอ่านไม่เจอหรือไม่แน่ใจให้ใส่ "" ทันที ห้ามเดา ห้ามประมาณ ห้ามสร้างข้อมูลเอง โดยเฉพาะ ชื่อบุคคล เลขทะเบียน เลขที่ใบอนุญาต เลขรับ วันที่
