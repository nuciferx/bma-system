...
กฎสำคัญ:
- ห้ามเดาข้อมูลที่อ่านไม่เจอในภาพ แม้จะคิดว่าน่าจะเป็นอะไร ให้ใส่ "" เสมอ แล้วใส่ชื่อ field นั้นใน missing_fields
- ห้ามเติมข้อมูลจากความรู้ทั่วไปหรือบริบท ใช้เฉพาะข้อมูลที่เห็นชัดในภาพเท่านั้น
- ถ้าอ่านได้บางส่วนแต่ไม่แน่ใจ → ใส่สิ่งที่อ่านได้ และเพิ่มชื่อ field นั้นใน low_confidence_fields
