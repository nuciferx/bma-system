      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 sticky top-0 z-10 shadow-sm">
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-400 truncate mt-0.5">{building.owner_name}</p>
          </div>
        ...
        {activeTab === 'info' && latestAction && (
          <div className="space-y-4">
            ...
            {latestAction.supervisor_changes.length > 0 && (
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
                <p className="text-xs font-bold text-slate-500 mb-3">การแจ้ง/เปลี่ยนผู้ควบคุมครั้งนี้</p>
